...
def main():
    ...
    ap.add_argument("--forecast_path", default="gs://weatherbench2/datasets/ens/2018-2022-240x121_equiangular_with_poles_conservative_mean.zarr")
    ap.add_argument("--obs_path", default="gs://weatherbench2/datasets/era5/1959-2023_01_10-6h-240x121_equiangular_with_poles_conservative.zarr")
